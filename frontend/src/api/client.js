// All API calls go through here. Since vite.config.js proxies /api/* to
// localhost:8000, we don't need to hardcode any base URL.
...
export async function ingestTextbook(file, subject) {
